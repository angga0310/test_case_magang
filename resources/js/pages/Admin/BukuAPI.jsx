...
export default function BukuAPI() {
    const { buku, fetchbuku, addBook, updateBook, deleteBook, loading, error } =
        useBukuStoreAPI();
                            ...
                            {filteredbuku.length > 0 ? (
                                filteredbuku.map((buku) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-3 py-5 text-center flex items-center gap-1 justify-center">
                                            <button
                                                onClick={() =>
                                                    openEditModal(buku)
                                                }
